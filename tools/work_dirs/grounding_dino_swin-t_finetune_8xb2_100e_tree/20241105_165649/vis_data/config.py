...
backend_args = None
class_name = ('tree crown', )
data_root = '/home/test/桌面/mmdetection-main/data/tree(rgb1+rgb2)/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/home/test/桌面/mmdetection-main/data/tree(rgb1+rgb2)/',
        metainfo=dict(classes=('tree crown', ), palette=[
            (
                220,
                20,
                60,
...
test_evaluator = dict(
    ann_file=
    '/home/test/桌面/mmdetection-main/data/tree(rgb1+rgb2)/annotations/test.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = './work_dirs/grounding_dino_swin-t_finetune_8xb2_100e_tree'
